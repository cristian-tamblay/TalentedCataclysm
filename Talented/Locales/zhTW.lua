...
L["Lock template"] = "鎖定模板"
L["Edit talents"] = "編輯天賦"
L["Toggle locking of the template."] = "切換模板的鎖定。"
...
L["Copy from primary talents"] = "從主天賦複製範本"
L["Copy from secondary talents"] = "從副天賦複製範本"
...
L["Sorry, I can't apply this template because it has the wrong primary talent tree selected"] = "抱歉，無法應用該範本，因為它的主天賦樹不正確"
L["Nothing to do"] = "什麼都不做"
L["Talented has applied your template to the preview. Review the result and press Learn to validate."] = "Talented 已應用了你的範本於預覽. 請審查結果並按學習來完成."
...
L["The template '%s' is no longer valid and has been removed."] = "以下的範本 '%s' 已不再有效，並已被刪除."
L["The template '%s' had inconsistencies and has been fixed. Please check it before applying."] = "以下的範本 '%s' 有不一致之處並已得到修復. 應用前請檢查一下."
...
L["Right-click to activate this spec"] = "右鍵單擊來激活這個天賦"
