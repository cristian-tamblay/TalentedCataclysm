...
L["Lock template"] = "템플릿 잠금"
L["Edit talents"] = "특성 편집"
L["Toggle locking of the template."] = "템플릿 잠금을 전환합니다."
...
L["Copy from primary talents"] = "기본 특성 복사"
L["Copy from secondary talents"] = "보조 특성 복사"
...
L["Sorry, I can't apply this template because it has the wrong primary talent tree selected"] = "선택된 기본 특성 트리가 잘못되어 있어 이 템플릿은 적용할 수 없습니다."
L["Nothing to do"] = "아무것도 할 수 없음"
L["Talented has applied your template to the preview. Review the result and press Learn to validate."] = "Talented로 템플릿을 미리보고 적용할 수 있습니다. 미리보기 한 결과 및 유효한 결과에 배우기를 누릅니다."
