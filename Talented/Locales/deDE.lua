...
L["Lock template"] = "Vorlage bearbeiten"
L["Edit talents"] = "Talente änderbar"
L["Toggle locking of the template."] = "Sperren der Vorlage umschalten."
...
L["Copy from primary talents"] = "Von erster Talentspezialisierung kopieren"
L["Copy from secondary talents"] = "Von zweiter Talentspezialisierung kopieren"
...
L["Sorry, I can't apply this template because it has the wrong primary talent tree selected"] = "Vorlage konnte nicht zugewiesen werden, weil der falsche Hauptspezialisierungsbaum ausgewählt wurde."
L["Nothing to do"] = "Es gibt nichts zuzuweisen"
L["Talented has applied your template to the preview. Review the result and press Learn to validate."] = "Talented hat Deine Vorlage zur Vorschau hinzugefügt. Überprüfe das Ergbnis und klick auf 'Erlernen' zum bestätigen."
