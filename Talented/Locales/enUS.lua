...
L["Lock template"] = true
L["Edit talents"] = true
L["Toggle locking of the template."] = true
...
L["Copy from primary talents"] = true
L["Copy from secondary talents"] = true
...
L["Sorry, I can't apply this template because it has the wrong primary talent tree selected"] = true
L["Nothing to do"] = true
L["Talented has applied your template to the preview. Review the result and press Learn to validate."] = true
